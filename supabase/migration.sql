...
CREATE TABLE IF NOT EXISTS deployment_attempts (
  ...
  selected_identity JSONB DEFAULT '{}',
...
ALTER TABLE deployment_attempts
  ...
  ADD COLUMN IF NOT EXISTS confirmation_latency_ms INTEGER DEFAULT 0,
  ADD COLUMN IF NOT EXISTS launch_score INTEGER DEFAULT 0,
  ADD COLUMN IF NOT EXISTS selected_identity JSONB DEFAULT '{}',
